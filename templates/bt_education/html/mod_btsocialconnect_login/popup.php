...
<div id="btl">
	...
	<div class="btl-panel">
		...
		<?php else : ?>
			<!-- Login button -->
			<span id="btl-panel-login" href="#btl-content-login" class="<?php echo $effect;?>"><span><?php echo JText::_('JLOGIN');?></span></span>
			...
			?>
			<span id="btl-panel-registration" href="#btl-content-registration" class="<?php echo $effect;?>"><span><?php echo JText::_('JREGISTER');?></span></span>
			<?php }
			} ?>
