		...
		<div  style="<?php echo $add_style;?>">
				...
				<?php if( $showDate ): ?>
					<span class="bt-date-2">
						...
						<span class="bt-date-month"><?php echo JHTML::_('date', $row->date, 'F'); ?></span>
						<span class="bt-date-day"><?php echo JHTML::_('date', $row->date, 'd'); ?></span>
				...
				<div class="bt_inner_infor">
					...
					<?php if($show_category_name_as_link) : ?>
						...
						<?php if( $showAuthor ): ?>
							...
							<?php // echo JText::sprintf('BT_EDUCATION_BT_CREATEDON', $row->date); ?>
							<?php echo JHTML::_('date', $row->date, JText::_('BT_EDUCATION_BT_CREATEDON2')); ?>
							</span>
							<?php endif; ?>
						</div>
						<?php endif; ?>
