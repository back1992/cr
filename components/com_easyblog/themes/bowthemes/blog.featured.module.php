			...
			<li class="featured-item">
				...
				<div class="featured-author">
					...
					<div class="showcase-author">
						<div class="featured_item_author"> <a href="<?php echo $row->author->getProfileLink(); ?>"><?php echo $row->author->getName(); ?></a></div>
						<div class="feature_item_date"><?php echo $this->formatDate('d M, Y' , $row->created ); ?></div>
					</div>
				</div>
				<div class="featured-meta">
					<h3 class="featured-title rip"><a href="<?php echo EasyBlogRouter::_( 'index.php?option=com_easyblog&view=entry&id=' . $row->id );?>"><?php echo $row->title;?></a></h3>
						...
						<div class="bt-blog readmore">
							...
							<!-- Readmore link -->
							<a href="<?php echo EasyBlogRouter::_('index.php?option=com_easyblog&view=entry&id='.$row->id); ?>"  class="featured-readmore"><span><?php echo JText::_('BT_COM_EASYBLOG_READ_MORE'); ?></span></a>
						</div>						
...
<?php } ?>
<script type="text/javascript">
	jQuery('#ezblog-featured .slider-holder').css('height', ((jQuery('#ezblog-featured .slider-holder .featured-entries').outerHeight()) + 'px'));
</script>
