...
<div class="navbar js-toolbar">
  <div class="navbar-inner">
      <a class="btn btn-navbar js-bar-collapse-btn">
        ...
        <span class="icon-bar"></span>
      	...
      	<ul class="nav hidden-desktop">
        	<li <?php echo $active == 0 ? ' class="active"' :'';?> ><a class="menu-icon" href="<?php echo CRoute::_( 'index.php?option=com_community&view=frontpage' );?>">
        		<i class="joms-icon-home"></i></a>
					...
					<?php }?>
					<li>
						<a class="menu-icon" href="javascript:void(0);" title="<?php echo JText::_('COM_COMMUNITY_LOGOUT'); ?>" onclick="document.communitylogout2.submit();">
      ...
      <div class="nav-collapse collapse js-bar-collapse">
        <ul class="nav">
        	<li class="<?php echo $active == 0 ? 'active' :'';?> visible-desktop" ><a class="menu-icon" href="<?php echo CRoute::_( 'index.php?option=com_community&view=frontpage' );?>">
        		<i class="joms-icon-home"></i></a>
			</li>
        ...
        <ul class="nav pull-right">
			...
			<li class="visible-desktop" >
				<a class="menu-icon" href="javascript:void(0);" title="<?php echo JText::_('COM_COMMUNITY_LOGOUT'); ?>" onclick="document.communitylogout.submit();">
					<i class="joms-icon-exit"></i>
				</a>
