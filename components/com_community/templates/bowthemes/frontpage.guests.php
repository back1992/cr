...
<div class="frontpage_guest_arena">
<div class="row-fluid hero-area">
	<div class="hero-area-wrapper">
		<img class="hero-area-bg" src="<?php echo JURI::root(); ?>components/com_community/templates/bowthemes/images/guest-bg.jpg"></img>

		<div class="content hidden-phone">
				
			<div class="title-link-register">	
				<div class="row-fluid">
						
					
						<h1 class="title_intro"><?php echo JText::_('COM_COMMUNITY_GET_CONNECTED_TITLE'); ?></h1>
					
						
							<?php if ($allowUserRegister) : ?>
							<a class="link_register" href="<?php echo CRoute::_( 'index.php?option=com_community&view=register' , false ); ?>">
			...
			<div class="content-cta">
				<div class="row-fluid">
					<div class="span9">
						<div class="text_intro_guest_box"><?php echo JText::_('COM_COMMUNITY_HERO_PARAGRAPH'); ?></div>
					</div>
...
<div class="cGuest">
	...
	<form class="reset-gap" action="<?php echo CRoute::getURI();?>" method="post" name="login" id="form-login" >
		...
		<div class="row-fluid">
			...
			<div class="span2">
				<input type="submit" value="<?php echo JText::_('COM_COMMUNITY_LOGIN_BUTTON');?>" name="submit" id="submit" class="button_guest_register"  tabindex="3" />
			</div>
