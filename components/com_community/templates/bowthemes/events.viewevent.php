...
<div class="js-focus" style="background-image:url('<?php echo $event->getCover(); ?>');">
		...
		<div class="navbar">
		  <div class="navbar-inner">
		      ...
		      <div class="nav-collapse collapse js-collapse">
		        ...
		        <ul class="nav pull-right nav-option">
		          <li class="dropup">
...
<div class="row-fluid">
	...
	<div class="span4">
		...
		<div class="cSidebar">
			...
			<?php $this->renderModules( 'js_events_side_top', $attribs ); ?>
			...
			<div id="community-event-members" class="jomsocial-module cEvent-Member app-box">

				<h3 class="module-title"><?php echo JText::sprintf('COM_COMMUNITY_EVENTS_CONFIRMED_GUESTS'); ?></h3>
			...
			<?php if( $config->get('eventshowmap') && ( $handler->isAllowed() || $event->permission != COMMUNITY_PRIVATE_EVENT ) ) {	?>
				...
				if(CMapping::validateAddress($event->location)){
					?>
					<div id="community-event-map" class="jomsocial-module cEvent-Map app-box">
						<h3 class="module-title"><?php echo JText::_('COM_COMMUNITY_MAP_LOCATION');?></h3>
					<div class="module-ct-inner">	
			...
			<div class="cGroup-Events jomsocial-module app-box">
		...
		<?php $this->renderModules( 'js_events_side_bottom', $attribs ); ?>
