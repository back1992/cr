			...
			<div class="cMedia-Box">
				<div class="cMedia-Avatar">
					...
					<div class="cMedia-Controls visible-desktop">
						<a class="photo_remove_button" href="javascript:void(0);" title="<?php echo JText::_('COM_COMMUNITY_REMOVE');?>" onclick="joms.gallery.confirmRemovePhoto('<?php echo $row->id;?>');">
			...
			<div class="span4">
				<div class="cSidebar">
					...
					<div class="jomsocial-module app-box">
						<h3 class="module-title cResetH"><?php echo JText::sprintf('COM_COMMUNITY_PHOTOS_ALBUM_TAKEN_AT_DESC', ''); ?></h3>
					...
					<div class="jomsocial-module app-box">
						<h3 class="module-title cResetH"><?php echo JText::_('COM_COMMUNITY_GROUPS_OTHER_ALBUMS'); ?></h3>
					<div class="module-ct-inner">
					...
					?>
					<div class="jomsocial-module app-box">
						<h3 class="module-title"><?php echo JText::_('COM_COMMUNITY_PHOTOS_OTHER_ALBUMS');?></h3>
					<div class="module-ct-inner">
						<div class="app-box-content">
							<ul class="cThumbDetails cResetList">
								<?php
