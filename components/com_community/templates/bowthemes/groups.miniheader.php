	...
	<div class="row-fluid">
		...
		<div class="span8">
			<ul class="cToolBox-Options unstyled">
				...
				<li class="btn-event bg-a-l">
					<a class="bg-a-r userinfo-event" href="<?php echo CRoute::_('index.php?option=com_community&view=events&task=display&groupid='.$group->id); ?>">
				...
				<li class="btn-photo bg-a-l">
					<a class="bg-a-r userinfo-photo" href="<?php echo CRoute::_('index.php?option=com_community&view=photos&task=display&groupid='.$group->id); ?>">
				...
				<li class="btn-videos bg-a-l">
					<a class="bg-a-r userinfo-video" href="<?php echo CRoute::_('index.php?option=com_community&view=videos&task=display&groupid='.$group->id); ?>">
				...
				<li class="btn-group-discussion bg-a-l">
					<a class="group-discussion bg-a-r" href="<?php echo CRoute::_('index.php?option=com_community&view=groups&task=viewdiscussions&groupid='.$group->id); ?>">
				...
				<li class="btn-group-member bg-a-l">
					<a class="btn-group-member bg-a-r" href="<?php echo CRoute::_('index.php?option=com_community&view=groups&task=viewmembers&groupid='.$group->id); ?>">
