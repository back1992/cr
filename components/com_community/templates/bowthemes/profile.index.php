...
<div id="cProfileWrapper" class="row-fluid cPage cProfile <?php if(!$isMine) { echo 'cProfileOther';} ?>">
	...
	<?php $this->renderModules( 'js_profile_top', $attribs ); ?>
	<?php if($isMine) $this->renderModules( 'js_profile_mine_top', $attribs ); ?>
	...
	<div class="row-fluid">
		<div class="span8">
			...
			<div class="cMain">
				...
				<?php $this->renderModules( 'js_profile_feed_top', $attribs ); ?>
				<div class="activity-stream-front">
					...
					<?php $this->renderModules( 'js_profile_feed_bottom', $attribs ); ?>
		...
		<div class="span4">
			...
			<div class="cSidebar">
				<?php
					...
					$this->renderModules( 'js_side_top', $attribs );
					$this->renderModules( 'js_profile_side_top', $attribs );
					echo $sidebarTop;

					if($isMine) $this->renderModules( 'js_profile_mine_side_top', $attribs );
					...
					if($isMine) $this->renderModules( 'js_profile_mine_side_bottom', $attribs );

					echo $sidebarBottom;
					$this->renderModules( 'js_profile_side_bottom', $attribs );
					$this->renderModules( 'js_side_bottom', $attribs );
				?>
			</div>
			<!-- end: .cSidebar -->
		</div>
	...
	<?php if($isMine) $this->renderModules( 'js_profile_mine_bottom', $attribs ); ?>
	<?php $this->renderModules( 'js_profile_bottom', $attribs ); ?>
