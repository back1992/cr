...
<div class="cIndex">
	...
	<div class="row-fluid">
		...
		<div class="span4">
			<div class="cSidebar">
				<!--Videos Category-->
				<div class="cVideos-Categories module_menu_sidebar">
					<h3 class="module-title"><?php echo JText::_('COM_COMMUNITY_VIDEOS_CATEGORY');?></h3>
						...
						<ul class="nav">
							...
							<li>
								...
								<a href="<?php echo CRoute::_($catVideoUrl . $row->id ); ?>">
									...
									<span>(<?php echo empty($row->count) ? '0' : $row->count; ?>)</span>
								</a>
				...
				<div class="jomsocial-module cVideos-Authors app-box">
					<h3 class="module-title cResetH"><?php echo JText::_('COM_COMMUNITY_VIDEOS_FEATURED_USERS');?></h3>
					<div class="module-ct-inner">
					<div class="app-box-content">
