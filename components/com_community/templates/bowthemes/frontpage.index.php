                    ...
                    <div class="joms-activity-filter clearfix">
                        ...
                        <form class="reset-gap">
                            ...
                            <ul class="unstyled joms-activity-filter-dropdown joms-postbox-dropdown" style="display: none">
                                ...
                                <?php } ?>
                                <li data-filter="privacy" data-value="me-and-friends" class="<?php echo ($filter == 'privacy' && $filterValue == "me-and-friends") ? 'active' : ''; ?>" data-url="<?php echo JRoute::_('index.php?option=com_community&view=frontpage&filter=privacy&value=me-and-friends');?>"><i class="joms-icon-user2"></i> <?php echo JText::_("COM_COMMUNITY_FILTERBAR_MEANDFRIENDS"); ?></li>
                            </ul>
                        </form>
                    </div>
    ...
    <?php if ($moduleCount > 0) { ?>
        <div class="span4">
            <div class="cSidebar">
                ...
                <?php $this->renderModules('js_side_frontpage', $attribs ); ?>
