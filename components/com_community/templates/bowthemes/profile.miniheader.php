...
<div class="cToolBox cProfile-ToolBox clearfix">
	...
	<div class="span8">
		<ul class="cToolBox-Options unstyled">
			...
			<li class="btn-add-friend bg-a-l">
				<a class="bg-a-r userinfo-addfriend" href="javascript:void(0)" onclick="joms.friends.connect('<?php echo $user->id;?>')">
			...
			<li class="btn-photo bg-a-l">
				<a class="bg-a-r userinfo-photo" href="<?php echo CRoute::_('index.php?option=com_community&view=photos&task=myphotos&userid='.$user->id); ?>">
			...
			<li class="btn-videos bg-a-l">
				<a class="bg-a-r userinfo-video" href="<?php echo CRoute::_('index.php?option=com_community&view=videos&task=myvideos&userid='.$user->id); ?>">
			...
			<li class="btn-send-message bg-a-l">
				<a class="bg-a-r userinfo-send-message" onclick="<?php echo $sendMsg; ?>" href="javascript:void(0);">
