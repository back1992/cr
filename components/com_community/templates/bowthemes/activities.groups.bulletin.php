...
$stream->headline = '<div class="stream-content-title"><a class="joms-stream-author" href="' .CUrlHelper::userLink($user->id).'">'.$user->getDisplayName().'</a> ' . JTEXT::_('COM_COMMUNITY_GROUPS_NEW_GROUP_NEWS') . '</div><div class="activitie_privacy"><span class="joms-share-meta date">' . $stream->datetime . '</span></div>';
$stream->message = "";
$stream->group = $group;
