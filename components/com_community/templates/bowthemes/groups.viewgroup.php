...
<div class="js-focus" style="background-image:url('<?php echo $group->getCover(); ?>');">
  ...
  <div class="js-focus-content">
    <div class="js-focus-content-inner">

      <div class="cover-block-avatar">
        <div class="cover-avatar js-focus-avatar">
		...
		<div class="cover-block-infor">
          <div class="cover-block-infor-name">
            <div class="cover-block-name">
              <h3><?php echo $group->name; ?></h3>
            </div>
            <div class="cover-block-infor-detail">
    ...
    <div class="navbar">
      <div class="navbar-inner">
          ...
          <?php if(($config->get('enablereporting') == 1 && $my->id != 0) || ( $config->get('enablereporting') == 1 && $config->get('enableguestreporting') == 1 && $my->id == 0)){?>
            ...
            <ul class="nav nav-option pull-right">
              <li class="dropup">
...
<div class="row-fluid">
  ...
  <div class="span4">
    ...
    <?php $this->renderModules( 'js_side_top', $attribs ); ?>
    <?php $this->renderModules( 'js_groups_side_top', $attribs ); ?>
      ...
      <?php if($members){ ?>
      <div class="jomsocial-module cGroups-Members app-box">
        <h3 class="module-title"><?php echo JText::sprintf('COM_COMMUNITY_GROUPS_MEMBERS'); ?></h3>
	<div class="module-ct-inner">
      ...
      <?php if( $showEvents ){ ?>
      <div class="jomsocial-module app-box">
        <h3 class="module-title"><?php echo JText::_('COM_COMMUNITY_EVENTS');?></h3>
	<div class="module-ct-inner">
        <div class="app-box-content">
          <?php if( $events ){ ?>
      ...
      <?php if( $albums ) { ?>
      <div class="jomsocial-module cGroupPhotos app-box">
        <h3 class="module-title"><?php echo JText::_('COM_COMMUNITY_PHOTOS_PHOTO_ALBUMS');?></h3>
	<div class="module-ct-inner">
        <div class="app-box-content">
      ...
      <?php if($videos) { ?>
      <div class="jomsocial-module app-box">
        <h3 class="module-title cResetH"><?php echo JText::_('COM_COMMUNITY_VIDEOS');?></h3>
	<div class="module-ct-inner">
        <div class="app-box-content">
    ...
    <?php $this->renderModules( 'js_groups_side_bottom', $attribs ); ?>
    <?php $this->renderModules( 'js_side_bottom', $attribs ); ?>
