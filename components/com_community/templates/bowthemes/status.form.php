...
<script>
  ...
  joms.language.mood.happy                    = '<?php echo addslashes( JText::_("COM_COMMUNITY_MOOD_HAPPY") ); ?>';
  joms.language.mood.meh                      = '<?php echo addslashes( JText::_("COM_COMMUNITY_MOOD_MEH") ); ?>';
  joms.language.mood.sad                      = '<?php echo addslashes( JText::_("COM_COMMUNITY_MOOD_SAD") ); ?>';
  joms.language.mood.loved                    = '<?php echo addslashes( JText::_("COM_COMMUNITY_MOOD_LOVED") ); ?>';
  joms.language.mood.excited                  = '<?php echo addslashes( JText::_("COM_COMMUNITY_MOOD_EXCITED") ); ?>';
  joms.language.mood.pretty                   = '<?php echo addslashes( JText::_("COM_COMMUNITY_MOOD_PRETTY") ); ?>';
  joms.language.mood.tired                    = '<?php echo addslashes( JText::_("COM_COMMUNITY_MOOD_TIRED") ); ?>';
  joms.language.mood.angry                    = '<?php echo addslashes( JText::_("COM_COMMUNITY_MOOD_ANGRY") ); ?>';
  joms.language.mood.speachless               = '<?php echo addslashes( JText::_("COM_COMMUNITY_MOOD_SPEACHLESS") ); ?>';
  joms.language.mood.shocked                  = '<?php echo addslashes( JText::_("COM_COMMUNITY_MOOD_SHOCKED") ); ?>';
  joms.language.mood.irretated                = '<?php echo addslashes( JText::_("COM_COMMUNITY_MOOD_IRRETATED") ); ?>';
  joms.language.mood.sick                     = '<?php echo addslashes( JText::_("COM_COMMUNITY_MOOD_SICK") ); ?>';
  joms.language.mood.annoyed                  = '<?php echo addslashes( JText::_("COM_COMMUNITY_MOOD_ANNOYED") ); ?>';
  joms.language.mood.relieved                 = '<?php echo addslashes( JText::_("COM_COMMUNITY_MOOD_RELIEVED") ); ?>';
  joms.language.mood.blessed                  = '<?php echo addslashes( JText::_("COM_COMMUNITY_MOOD_BLESSED") ); ?>';
  joms.language.mood.bored                    = '<?php echo addslashes( JText::_("COM_COMMUNITY_MOOD_BORED") ); ?>';

  joms.language.moodshort || (joms.language.moodshort = {});
  joms.language.moodshort.happy               = '<?php echo addslashes( JText::_("COM_COMMUNITY_MOOD_SHORT_HAPPY") ); ?>';
  joms.language.moodshort.meh                 = '<?php echo addslashes( JText::_("COM_COMMUNITY_MOOD_SHORT_MEH") ); ?>';
  joms.language.moodshort.sad                 = '<?php echo addslashes( JText::_("COM_COMMUNITY_MOOD_SHORT_SAD") ); ?>';
  joms.language.moodshort.loved               = '<?php echo addslashes( JText::_("COM_COMMUNITY_MOOD_SHORT_LOVED") ); ?>';
  joms.language.moodshort.excited             = '<?php echo addslashes( JText::_("COM_COMMUNITY_MOOD_SHORT_EXCITED") ); ?>';
  joms.language.moodshort.pretty              = '<?php echo addslashes( JText::_("COM_COMMUNITY_MOOD_SHORT_PRETTY") ); ?>';
  joms.language.moodshort.tired               = '<?php echo addslashes( JText::_("COM_COMMUNITY_MOOD_SHORT_TIRED") ); ?>';
  joms.language.moodshort.angry               = '<?php echo addslashes( JText::_("COM_COMMUNITY_MOOD_SHORT_ANGRY") ); ?>';
  joms.language.moodshort.speachless          = '<?php echo addslashes( JText::_("COM_COMMUNITY_MOOD_SHORT_SPEACHLESS") ); ?>';
  joms.language.moodshort.shocked             = '<?php echo addslashes( JText::_("COM_COMMUNITY_MOOD_SHORT_SHOCKED") ); ?>';
  joms.language.moodshort.irretated           = '<?php echo addslashes( JText::_("COM_COMMUNITY_MOOD_SHORT_IRRETATED") ); ?>';
  joms.language.moodshort.sick                = '<?php echo addslashes( JText::_("COM_COMMUNITY_MOOD_SHORT_SICK") ); ?>';
  joms.language.moodshort.annoyed             = '<?php echo addslashes( JText::_("COM_COMMUNITY_MOOD_SHORT_ANNOYED") ); ?>';
  joms.language.moodshort.relieved            = '<?php echo addslashes( JText::_("COM_COMMUNITY_MOOD_SHORT_RELIEVED") ); ?>';
  joms.language.moodshort.blessed             = '<?php echo addslashes( JText::_("COM_COMMUNITY_MOOD_SHORT_BLESSED") ); ?>';
  joms.language.moodshort.bored               = '<?php echo addslashes( JText::_("COM_COMMUNITY_MOOD_SHORT_BORED") ); ?>';
